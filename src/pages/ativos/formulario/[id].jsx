    ...
    async function getItem() {
        await axios.get('/api/ativo', {
            ...
            .then(data => {
                ...
                setTipoAtivo(JSON.stringify(data.tipo_ativo));
                setMarca(JSON.stringify(data.marca));
                setResponsavel(JSON.stringify(data.responsavel));
                setLocalidade(JSON.stringify(data.localidade));
